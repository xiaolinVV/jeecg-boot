package org.jeecg.modules.demo.testOrderMain_erp.vo;
 ...
 */
@Data
@ApiModel(value="test_order_mainPage对象", description="测试订单主表-ERP")
public class TestOrderMainErpPage {
	...
	private List<TestOrderProductErp> testOrderProductErpList;
