package org.jeecg.modules.demo.testOrderMain_innerTable.vo;
 ...
 */
@Data
@ApiModel(value="test_order_mainPage对象", description="测试订单主表-内嵌子表风格")
public class TestOrderMainInnerTablePage {
	...
	private List<TestOrderProductInnerTable> testOrderProductInnerTableList;
