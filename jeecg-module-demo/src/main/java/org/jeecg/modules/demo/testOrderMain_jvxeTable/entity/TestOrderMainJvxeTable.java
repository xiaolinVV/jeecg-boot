package org.jeecg.modules.demo.testOrderMain_jvxeTable.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="test_order_main对象", description="测试订单主表,jvxe风格")
@Data
@TableName("test_order_main")
public class TestOrderMainJvxeTable implements Serializable {
