package org.jeecg.modules.demo.testOrderMain_erp.entity;
...
@ApiModel(value="test_order_main对象", description="测试订单主表-ERP")
public class TestOrderMainErp implements Serializable {
