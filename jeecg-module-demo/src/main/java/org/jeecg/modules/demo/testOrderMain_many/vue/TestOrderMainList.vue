  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/testOrderMain_many/testOrderMain/list",
          delete: "/testOrderMain_many/testOrderMain/delete",
          deleteBatch: "/testOrderMain_many/testOrderMain/deleteBatch",
          exportXlsUrl: "/testOrderMain_many/testOrderMain/exportXls",
          importExcelUrl: "testOrderMain_many/testOrderMain/importExcel",
