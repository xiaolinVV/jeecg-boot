 ...
 */
@Data
@TableName("marketing_fourth_integral_record")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_fourth_integral_record对象", description="第四积分记录")
public class MarketingFourthIntegralRecord {
	...
	@Dict(dicCode = "fourth_integral_deal_type")
