 ...
 */
@Data
@TableName("sys_blance_capital_detail")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="sys_blance_capital_detail对象", description="平台交易明细")
public class SysBlanceCapitalDetail {
