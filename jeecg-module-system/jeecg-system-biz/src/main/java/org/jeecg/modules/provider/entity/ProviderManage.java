...
public class ProviderManage {
	...
	/**对接数据来源:0.本平台 1.京东供应链*/
	@Excel(name = "对接数据来源:0.本平台 1.京东供应链", width = 15)
	@ApiModelProperty(value = "对接数据来源:0.本平台 1.京东供应链")
	private String source;

	/**供应商分类:0.普通 1.vip供应商*/
	@Excel(name = "供应商分类:0.普通 1.vip供应商", width = 15)
	@ApiModelProperty(value = "供应商分类:0.普通 1.vip供应商")
