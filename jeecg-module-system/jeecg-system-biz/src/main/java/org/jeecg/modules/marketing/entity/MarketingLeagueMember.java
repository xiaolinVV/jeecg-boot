 ...
 */
@Data
@TableName("marketing_league_member")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_league_member对象", description="加盟专区-人员关系")
public class MarketingLeagueMember {
	...
	/**父类会员id*/
	@Excel(name = "父类会员id", width = 15)
    @ApiModelProperty(value = "父类会员id")
	...
	private String srcParantId;

	private String storeManagerSupportAward;


	private String sysAreas;
