 ...
 */
@Data
@TableName("member_designation_count")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="member_designation_count对象", description="会员称号统计")
public class MemberDesignationCountDTO {
	...
	/**称号总人数*/
	@Excel(name = "称号总人数", width = 15)
    @ApiModelProperty(value = "称号总人数")
