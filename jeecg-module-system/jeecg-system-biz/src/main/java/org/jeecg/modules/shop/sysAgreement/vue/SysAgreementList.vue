<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="英文名">
              <a-input placeholder="请输入英文名" v-model="queryParam.english"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <sys-agreement-modal ref="modalForm" @ok="modalFormOk"></sys-agreement-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'english',text:'英文名',dictCode:''})
        ...
        fieldList.push({type:'Text',value:'contant',text:'内容',dictCode:''})
