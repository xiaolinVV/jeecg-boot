...
public class GoodStoreListVo {
  ...
  private List<GoodStoreListSpecificationVO> GoodListSpecificationVOs;
  /**查询条件开始时间*/
  ...
  private List<GoodStoreListSpecificationVO> goodStoreSpecificationList;
}
