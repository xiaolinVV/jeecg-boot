 ...
 */
@Data
@TableName("marketing_certificate_group_base_setting")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_certificate_group_base_setting对象", description="拼好券设置")
public class MarketingCertificateGroupBaseSetting {
	...
	/**默认成团人数*/
	@Excel(name = "默认成团人数", width = 15)
    @ApiModelProperty(value = "默认成团人数")
	private java.math.BigDecimal numberClusters;
	/**成团时间*/
	@Excel(name = "成团时间", width = 15)
