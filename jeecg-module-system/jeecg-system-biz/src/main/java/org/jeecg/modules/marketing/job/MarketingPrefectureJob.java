...
@Slf4j
@Component
public class MarketingPrefectureJob implements Job {
    @Autowired
    private IMarketingPrefectureService iMarketingPrefectureService;
    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
        log.info(" 每五分钟检查专区是否过期 !  时间:" + DateUtils.getTimestamp());
        iMarketingPrefectureService.getMarketingPrefectureOvertime();
    }
}
