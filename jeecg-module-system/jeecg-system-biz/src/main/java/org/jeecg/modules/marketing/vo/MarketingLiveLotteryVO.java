...
public class MarketingLiveLotteryVO {
	...
	/**中奖奖品*/
	@Excel(name = "中奖奖品", width = 15)
    @ApiModelProperty(value = "中奖奖品")
	private String lotteryPrize;
	/**未中奖奖品*/
	@Excel(name = "未中奖奖品", width = 15)
    @ApiModelProperty(value = "未中奖奖品")
	private String losingLotteryPrize;
	/**删除说明*/
	...
	private String lotteryPrizeQuantity;
	private String lotteryprizeTotal;
	private String losingLotteryPrizeType;
	private String losingLotteryPrizeId;
	private String losingLotteryPrizeQuantity;
