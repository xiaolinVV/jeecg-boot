 ...
 */
@Data
@TableName("member_attention_store")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="member_attention_store对象", description="关注店铺")
public class MemberAttentionStore {
	...
	/**角色为店铺的用户id*/
	@Excel(name = "角色为店铺的用户id", width = 15)
    @ApiModelProperty(value = "角色为店铺的用户id")
