...
@Data
public class MarketingPrefectureVO {
    /**
     * 主键ID
     */
     ...
     */
    @Excel(name = "专区购买限制；0：商品自定义限购；1：专区限购", width = 15)
    @ApiModelProperty(value = "专区购买限制；0：商品自定义限购；1：专区限购")
