...
/**
 * @Description: 店铺礼品卡商品列表
 * @Author: jeecg-boot
 * @Date:   2021-07-13
 * @Version: V1.0
 */
@Data
@TableName("marketing_store_gift_card_good_list")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_store_gift_card_good_list对象", description="店铺礼品卡商品列表")
public class MarketingStoreGiftCardGoodList {
