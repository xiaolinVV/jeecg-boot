...
public class OrderStoreListDTO {
	...
	private List<OrderStoreSubListDTO> orderStoreSubListDTOs;//OrderProviderListDTOs
	...
	/*商品总件数*/
	public BigDecimal  allUmberUnits;
	/*福利金*/
	...
	/**评论集合*/
	private List<OrderEvaluateStoreDTO>  orderEvaluateStoreDTOList;
	//买家账号
