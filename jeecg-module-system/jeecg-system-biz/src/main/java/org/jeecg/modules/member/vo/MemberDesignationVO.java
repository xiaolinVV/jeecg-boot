...
public class MemberDesignationVO {
	...
	//均分资金说明
	private String mdIsAverage;

	//参与低级分红说明
	private String mdLowLevelDividends;

	//自定义特权说明
	private String mdCustomRemark;

	//月绩效奖励说明
	private String mdIsMonthlyPerformance;
