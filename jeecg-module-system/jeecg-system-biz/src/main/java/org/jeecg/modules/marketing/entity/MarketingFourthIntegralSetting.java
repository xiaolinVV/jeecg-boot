 ...
 */
@Data
@TableName("marketing_fourth_integral_setting")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_fourth_integral_setting对象", description="第四积分设置")
public class MarketingFourthIntegralSetting {
	...
	/**积分名称*/
	@Excel(name = "积分名称", width = 15)
    @ApiModelProperty(value = "积分名称")
	private String integralName;
	/**积分图标*/
	@Excel(name = "积分图标", width = 15)
