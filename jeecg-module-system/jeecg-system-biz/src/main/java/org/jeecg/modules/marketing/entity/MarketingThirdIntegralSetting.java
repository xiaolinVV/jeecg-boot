 ...
 */
@Data
@TableName("marketing_third_integral_setting")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_third_integral_setting对象", description="第三积分设置")
public class MarketingThirdIntegralSetting {
