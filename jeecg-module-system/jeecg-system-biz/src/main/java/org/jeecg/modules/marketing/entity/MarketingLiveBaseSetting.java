 ...
 */
@Data
@TableName("marketing_live_base_setting")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_live_base_setting对象", description="直播管理-直播设置")
public class MarketingLiveBaseSetting {
	...
	/**直播别名*/
	@Excel(name = "直播别名", width = 15)
    @ApiModelProperty(value = "直播别名")
