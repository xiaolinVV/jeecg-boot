...
public class MarketingGiftBagBatchVO {
	...
	@Excel(name = "分配方式：0：按代理比例分配；1：按礼包比例分配", width = 15)
    @ApiModelProperty(value = "分配方式：0：按代理比例分配；1：按礼包比例分配")
	private String modeDistribution;
	/**分钱模式；0：按照代理或者加盟商的奖励；1：自定义奖励*/
	@Excel(name = "分钱模式；0：按加盟商比例分配；1：按礼包比例分配", width = 15)
    @ApiModelProperty(value = "分钱模式；0：按加盟商比例分配；1：按礼包比例分配")
