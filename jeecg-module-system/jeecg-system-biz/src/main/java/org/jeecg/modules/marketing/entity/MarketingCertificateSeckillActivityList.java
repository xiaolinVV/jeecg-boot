 ...
 */
@Data
@TableName("marketing_certificate_seckill_activity_list")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_certificate_seckill_activity_list对象", description="活动列表")
public class MarketingCertificateSeckillActivityList {
	...
	@Excel(name = "启用停用状态设置说明 ", width = 15)
	@ApiModelProperty(value = "启用停用状态设置说明 ")
