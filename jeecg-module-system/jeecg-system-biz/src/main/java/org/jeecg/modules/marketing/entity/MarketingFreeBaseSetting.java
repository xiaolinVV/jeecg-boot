 ...
 */
@Data
@TableName("marketing_free_base_setting")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_free_base_setting对象", description="免单基础设置")
public class MarketingFreeBaseSetting {
	...
	private java.math.BigDecimal promoteNumber;
	/**首页广告词*/
	@Excel(name = "首页广告词", width = 15)
    @ApiModelProperty(value = "首页广告词")
	private String advertisingCommentary;
	/**分销佣金；0：不奖励；1：奖励*/
