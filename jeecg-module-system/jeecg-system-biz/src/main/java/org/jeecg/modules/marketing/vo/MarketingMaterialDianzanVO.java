 ...
 */
@Data
@TableName("marketing_material_dianzan")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_material_dianzan对象", description="素材点赞")
public class MarketingMaterialDianzanVO {
	...
	/**查询条件开始时间*/
	private String browseTime_begin;
	/**查询条件开始时间*/
	private String browseTime_end;
}
