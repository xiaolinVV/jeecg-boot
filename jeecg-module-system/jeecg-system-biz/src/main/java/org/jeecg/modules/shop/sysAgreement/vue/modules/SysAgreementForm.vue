        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="英文名" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="english">
              <a-input v-model="model.english" placeholder="请输入英文名"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="内容" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="contant">
              <j-editor v-model="model.contant" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
    ...
    data () {
      return {
        ...
        url: {
          ...
          queryById: "/sysAgreement/sysAgreement/queryById"
        }
      }
    },
    computed: {
