 ...
 */
@Data
@TableName("marketing_store_prefecture_dividend")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_store_prefecture_dividend对象", description="店铺专区-记录分红明细")
public class MarketingStorePrefectureDividend {
	...
	/**专区记录id*/
	@Excel(name = "专区记录id", width = 15)
    @ApiModelProperty(value = "专区记录id")
	private String marketingStorePrefectureRecordId;
	/**会员列表id*/
