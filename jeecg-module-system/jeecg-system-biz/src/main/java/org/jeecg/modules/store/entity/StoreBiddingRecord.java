 ...
 */
@Data
@TableName("store_bidding_record")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="store_bidding_record对象", description="竞价记录")
public class StoreBiddingRecord {
	...
	/**竞价商品id*/
	@Excel(name = "竞价商品id", width = 15)
    @ApiModelProperty(value = "竞价商品id")
	private String storeBiddingGoodId;
}
