 ...
 */
@Data
@TableName("marketing_activity_registration_base_setting")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_activity_registration_base_setting对象", description="活动基础设置")
public class MarketingActivityRegistrationBaseSetting {
