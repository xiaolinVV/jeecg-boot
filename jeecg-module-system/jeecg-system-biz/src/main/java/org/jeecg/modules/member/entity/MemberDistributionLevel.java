 ...
 */
@Data
@TableName("member_distribution_level")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="member_distribution_level对象", description="会员分销等级关系")
public class MemberDistributionLevel {
	...
	/**分销等级id*/
	@Excel(name = "分销等级id", width = 15)
    @ApiModelProperty(value = "分销等级id")
	private String marketingDistributionLevelId;

	private BigDecimal upgradeDirect;

	private BigDecimal upgradeTeamNumber;
