 ...
 */
@Data
@TableName("marketing_certificate_group_list")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="marketing_certificate_group_list对象", description="拼好券")
public class MarketingCertificateGroupListVO {
