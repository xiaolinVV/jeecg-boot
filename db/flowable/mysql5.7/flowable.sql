...
CREATE TABLE `flow_my_business` (
                                    ...
                                    `del_flag` varchar(1) DEFAULT '0' COMMENT '逻辑删除 0=否 1=是',
                                    ...
                                    `process_instance_id` varchar(100) DEFAULT NULL COMMENT '流程业务实例id 一个流程业务唯一，本表中也唯一',
                                    ...
                                    `bpm_status` varchar(100) DEFAULT NULL COMMENT '流程状态说明，有：启动  撤回  驳回  审批中  审批通过  审批异常',
                                    ...
                                    `jimu_report_id` varchar(64) DEFAULT NULL COMMENT '积木报表ID, 可查看当前审批单挂载的单据报表页面',
                                    `pc_form_url` varchar(100) DEFAULT NULL COMMENT 'PC表单组件地址',
                                    `proposer_dept_id` varchar(50) DEFAULT NULL COMMENT '申请人部门ID',
                                    `proposer_dept_name` varchar(50) DEFAULT NULL COMMENT '申请人部门名称',
                                    `proposer_name` varchar(50) DEFAULT NULL COMMENT '申请人名称',
                                    PRIMARY KEY (`id`),
...
INSERT INTO `sys_dict_item`(`id`, `dict_id`, `item_text`, `item_value`, `description`, `sort_order`, `status`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('1533795486402048002', '1533795346018693121', '草稿', '0', '', 1, 1, 'admin', '2022-06-06 20:58:35', NULL, NULL);
